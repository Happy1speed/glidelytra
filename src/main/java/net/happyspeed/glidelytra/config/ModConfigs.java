...
public class ModConfigs {
    ...
    public static boolean CONFIGFIREWORKBOOSTINGENABLED;
    ...
    private static void createConfigs() {
        ...
        configs.addKeyValuePair(new Pair<>("boost_block_amplifier", 70.0));
        ...
        configs.addKeyValuePair(new Pair<>("firework_boosting_enabled", true));
    }
    ...
    private static void assignConfigs() {
        ...
        CONFIGBOOSTBLOCKAMPLIFIER = CONFIG.getOrDefault("boost_block_amplifier", 70.0);
        ...
        CONFIGFIREWORKBOOSTINGENABLED = CONFIG.getOrDefault("firework_boosting_enabled", true);
